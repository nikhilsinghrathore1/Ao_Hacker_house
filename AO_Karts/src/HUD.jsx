...
// okay so what all are left to do now well i first of all i have to shoot a video for and then i have to explain the project also have to create a new repo which will contain it all , that's it let's start with the repo 